		...
		<div class="col-md-6">
			<div class="todo-content mx-lg-1">
				<div class="todo-header pb-2 border-bottom border-gray d-flex" style="height: 38px;">
					...
					<a href="<?php echo e(route('tasks.create')); ?>" class="ml-auto">
...
<?php $__env->startSection("hidden-component"); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Darren Baculo\Documents\workspace\edenkite_capstone\resources\views/tasks/index.blade.php ENDPATH**/ ?>